...
const demoMessages = [
  {
    ...
    content:
      "I was arrested yesterday and the officer used excessive force. I have video evidence.",
    type: "text" as const,
  ...
  },
  {
    ...
    mediaUrl:
      "https://via.placeholder.com/400x300/ff6b6b/ffffff?text=Video+Evidence",
  },
  {
    id: "msg_003",
    ...
    content:
      "Thank you for reporting this incident. I have reviewed your complaint and will investigate this matter thoroughly. Can you provide more details about the time and exact location?",
    type: "text" as const,
  ...
  },
  {
    ...
    senderRole: "citizen" as const,
    content:
      "The incident happened at around 2:30 PM near the Central Police Station. There were several witnesses present.",
    type: "text" as const,
...
export default function Home() {
  ...
  const handleStatusUpdate = (
    ...
    setIncidents((prev) =>
      prev.map((incident) =>
        incident.id === reportId ? { ...incident, status } : incident
      )
    );
  ...
  const handleBulkStatusUpdate = (
    ...
    setIncidents((prev) =>
      prev.map((incident) =>
        reportIds.includes(incident.id) ? { ...incident, status } : incident
      )
    );
  ...
  if (currentScreen !== "citizen-view") {
    return (
      <div className="min-h-screen pb-16">
        {currentScreen === "login" && <OfficerLogin onLogin={handleLogin} />}
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16">
      ...
      <footer
        ...
        style={{ marginBottom: "calc(64px + env(safe-area-inset-bottom))" }}
      >
